...
public class GuidingSkintStructure extends Structure {
    ...
    protected GuidingSkintStructure(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Types> projectStartToHeightmap, int maxDistanceFromCenter) {
        super(config);
        this.size = size;
    ...
    public static final Codec<GuidingSkintStructure> CODEC = RecordCodecBuilder.<GuidingSkintStructure>mapCodec(instance ->
            instance.group(GuidingSkintStructure.settingsCodec(instance),
