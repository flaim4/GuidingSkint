package net.flaim.guiding_skint.structure;
...
public class GuidingSkintDesertStructure extends Structure {
    ...
    protected GuidingSkintDesertStructure(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Types> projectStartToHeightmap, int maxDistanceFromCenter) {
        super(config);
        this.size = size;
    ...
    public static final Codec<GuidingSkintDesertStructure> CODEC = RecordCodecBuilder.<GuidingSkintDesertStructure>mapCodec(instance ->
            instance.group(GuidingSkintDesertStructure.settingsCodec(instance),
            ...
            ).apply(instance, GuidingSkintDesertStructure::new)).codec();
